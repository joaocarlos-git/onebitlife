        ...
        <View style={styles.container}>
            ...
            <View style={styles.explanationContainer}>
                ...
                <Text style={styles.description}>
                    <Text style = {styles.mind}>Mente: </Text> Hábitos para melhorar sua inteligencia/sabedoria
                </Text>
            </View>
            ...
            <View style={styles.explanationContainer}>
                ...
                style={styles.icon}/>
                <Text style={styles.description}>
                    <Text style = {styles.money}>Financeiro: </Text> Hábitos para te ajudar no contgrole financeiro
                </Text>
            </View>
